...
| **Wild test** | replays **622 real mainnet swaps** across 4 live pools through the guard: max genuine move 0.43%, a 2% cap blocks **0 (0.00%)** — near-zero false positives on real traffic | `aegis wild` |
